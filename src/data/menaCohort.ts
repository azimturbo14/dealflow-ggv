...
export const MENA_COHORT: CohortRecord[] = [
  ...
  {
    input: { name: 'Kingpin', industry: 'B2B SaaS', country: 'United Arab Emirates', is_b2b: true, team_size: 20, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: true, technical_cofounder: true, stage: 'Launched', founding_year: 2021 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'funding_total_usd', 'funding_rounds', 'time_to_first_funding_months'],
    as_of_date: '2024-04-09',
    sources: ['Wamda 2025 $3.5M seed (Infinity Ventures, Red Swan, Mu Ventures, COTU, Outliers, Hub71) - POST-DECISION, see note', 'Entrepreneur ME coverage - POST-DECISION', 'Preqin/Kingpin (founded 2021)'],
    note: 'AI-native B2B distribution platform for brands/distributors. TEMPORAL FIX (2026-07 audit): the original record used the $3.5M seed round as funding_total_usd, but that round closed 2025-11-21 per Wamda/Entrepreneur ME - eighteen months AFTER the CRM\'s last-recorded-email on this deal (2024-04-09, stage Passed). The fund passed on this company before it had ANY funding. Corrected founding_year from the stale 2024 estimate to 2021 per Preqin/Wamda; corrected funding_total_usd/funding_rounds/time_to_first_funding_months to 0 to reflect the pre-decision (pre-funding) state, sharpening the classification as a too-early/pre-funding quality pass rather than an ambiguous close call.',
  },
  {
  ...
  },
  {
    ...
    note: 'Casablanca-based earned-wage-access / financial-wellness platform for African employers; founder Mossaab Abaouz is ex-Stanford CS (technical_cofounder confirmed). Raised undisclosed pre-Seed (Feb 2023, Ingressive Capital). Lucidity Insights now lists the startup as "Inactive" - a deadpooled/dormancy signal that further confirms the quality-driven pass.',
  },
  {
    input: { name: 'Jumlaty', industry: 'FoodTech', country: 'Saudi Arabia', is_b2b: true, team_size: 20, funding_total_usd: 0, funding_rounds: 1, time_to_first_funding_months: 12, has_previous_exit: false, sales_amount_usd: 0, unique_tech: true, technical_cofounder: true, stage: 'Launched', founding_year: 2020 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'funding_total_usd', 'time_to_first_funding_months', 'technical_cofounder'],
    as_of_date: '2024-12-24',
    sources: ['Wamda 2022-12 merger coverage (founded 2020)', 'ArabNews merger coverage', 'Tracxn Jumlaty company profile', 'Crunchbase Jumlaty profile'],
    note: 'B2B "Supply Chain as a Service" platform for restaurants (sourcing, replenishment, "Supply Now Pay Later"), spun out of Nomu\'s Jeddah venture studio; founders Salman Attieh and Ibrahim Mazoza (same studio that produced Nomu Group, also in this cohort). Founded 2020 per Wamda/ArabNews. Merged with Egypt\'s Appetito to form NOMU Group in Dec 2022; Crunchbase lists status as "Closed" (acquired/merged). Raised one funding round from one investor, amount undisclosed. Inferred quality pass on scale/disclosed-metrics thinness, not thesis.',
  },
  {
  ...
  },
  {
    ...
    note: 'Bookkeeping/tax/CFO-as-a-service SaaS for UAE SMEs; 200+ customers growing ~30%/month, backed by MBRIF/in5 Tech/Kube VC accelerator programs with no disclosed institutional round amount. Founder Muhammed Shafeekh was CFO at Mashkor and co-founded Lulu Sweets (bootstrapped to $4M revenue) - has_previous_exit kept false as the exit was a bootstrap build, not a VC-backed exit. Has a co-founder (Muhammed Musthafa, CPO) with business-analytics/Python background. On-thesis sector/geography; inferred quality pass on stage/scale (very early, no disclosed priced round) rather than a thesis mismatch.',
  },
  {
  ...
  {
    input: { name: 'eBinaa', industry: 'PropTech', country: 'Oman', is_b2b: false, team_size: 8, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: false, stage: 'Launched', founding_year: 2020 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size'],
    as_of_date: '2026-04-06',
    sources: ['Oman Startup Hub profile', 'eBinaa company blog (About Us)', 'LinkedIn - founder Husain Al-Asfoor'],
    note: 'Muscat-based digital construction marketplace connecting homeowners, contractors and consultants for custom-home builds; launched Oct 2020, won a COMEX ICT Invention award and an Oman Arab Bank hackathon prize. No institutional funding round or team-size disclosure found anywhere after nearly six years of operation, and only a single named founder surfaced in any source - thin scale and funding signal consistent with a quality-driven pass rather than a thesis mismatch (Oman/GCC is squarely on-geography).',
  },
  {
    input: { name: 'Banxx', industry: 'FinTech', country: 'United Arab Emirates', is_b2b: false, team_size: 10, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: false, stage: 'MVP', founding_year: 2023 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'founding_year'],
    as_of_date: '2025-11-23',
    sources: ['Hub71 startup directory listing', 'LinkedIn - founder/CEO Adam Rice'],
    note: 'Abu Dhabi personal-finance aggregator app (banking, cards, loans, investments, insurance) accepted into Hub71 Cohort 17. No disclosed funding amount, revenue, or user traction found beyond the accelerator listing itself, and the product sits in a crowded, largely undifferentiated personal-finance-aggregator category. Thin evidence of scale/differentiation reads as a quality-driven pass; on-geography (UAE).',
  },
  {
    input: { name: '0brokers', industry: 'PropTech', country: 'Egypt', is_b2b: false, team_size: 6, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: true, stage: 'MVP', founding_year: 2024 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size'],
    as_of_date: '2026-01-05',
    sources: ['Crunchbase organization profile', '0brokers company site', '0brokers Facebook (EMEA)'],
    note: 'No-commission real-estate marketplace ("no-broker" model) with active Cairo-area listings, founded ~May 2024 by Saif AlKhair (CEO) and Mourad ElSheraey (CTO, ex-Dytomic); Crunchbase lists a 1-10 person team and no funding round. Entity is nominally registered in Amsterdam but operational focus is Cairo/Egypt - used the substantive operating market for scoring, consistent with this cohort\'s convention for CRM/registration mismatches. Tiny team, no funding, and a marketing claim ("first AI agent in EMEA") unsupported by any independent coverage read as a quality-driven pass.',
  },
  {
    input: { name: 'Tatami', industry: 'PropTech', country: 'Qatar', is_b2b: false, team_size: 8, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: false, stage: 'MVP', founding_year: 2023 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'founding_year'],
    as_of_date: '2025-06-10',
    sources: ['F6S company profile', 'LinkedIn - founder Aimen Bedawi', 'tribetechie.com coverage'],
    note: 'Doha-based proptech digitizing rent payments and tenant-landlord interactions (AI tenant screening, Sharia-compliant rails), founded by Aimen Bedawi and Omar Al-Khal. No funding amount, revenue, or team-size figure found in any source beyond the founders\' own profiles - very thin evidence of traction or scale for an idea targeting a large, well-identified market. Reads as an early-stage quality-driven pass; on-geography (Qatar/GCC).',
  },
  {
    input: { name: 'Amplifier Health', industry: 'HealthTech', country: 'Canada', is_b2b: true, team_size: 6, funding_total_usd: 0, funding_rounds: 1, time_to_first_funding_months: 12, has_previous_exit: false, sales_amount_usd: 0, unique_tech: true, technical_cofounder: false, stage: 'Launched', founding_year: 2023 },
    actual_outcome: 'passed', pass_kind: 'thesis', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'time_to_first_funding_months', 'funding_total_usd'],
    as_of_date: '2025-09-10',
    sources: ['Crunchbase organization profile', 'Amplifier Health company site', 'PRWeb - TGH Ventures pitch-competition win'],
    note: 'CRM tags this deal Qatar (and an earlier "Lead" stage row tagged it United States) but every independent source confirms HQ is Calgary, Alberta, Canada, with no MENA connection found anywhere - flagging as a likely CRM data-entry anomaly, the same pattern as Pemo/Atmo Biosciences elsewhere in this cohort. AI voice-biomarker platform (1,000+ acoustic biomarkers from speech) for remote health screening; investors include Builders VC and Cartan Capital, plus a partnership with Xeomics and a TGH Ventures (Tampa General Hospital) pitch-competition win. Classified thesis: Canada/North America is outside this fund\'s core_regions and there is no substantive MENA nexus to justify treating it as on-geography.',
  },
  {
    input: { name: 'Getly', industry: 'FinTech', country: 'Nigeria', is_b2b: false, team_size: 10, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: false, stage: 'Launched', founding_year: 2022 },
    actual_outcome: 'passed', pass_kind: 'thesis', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'founding_year'],
    as_of_date: '2026-05-16',
    sources: ['Getly company site (about-us)', 'Getly Qatar product page', 'Web Summit Qatar 2026 exhibitor listing'],
    note: 'CRM tags this deal Qatar, but the legal entity (Getly Limited, subsidiary of Takeout Media Ltd) is registered and headquartered in Abuja, Nigeria, building cross-border payments/expense cards for African freelancers and businesses; it also runs a Qatar-facing product line and exhibited at Web Summit Qatar 2026 via the QSTP incubator, which is almost certainly why the CRM tagged it Qatar. Classified thesis: true HQ (Nigeria/Sub-Saharan Africa) is outside this fund\'s core_regions, the same pattern as Dojah and FairMoney elsewhere in this cohort - the Qatar presence is a go-to-market channel, not the headquarters.',
  },
  {
    input: { name: 'Medex Cart', industry: 'E-Commerce', country: 'Turkey', is_b2b: true, team_size: 8, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: false, stage: 'Launched', founding_year: 2021 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'technical_cofounder'],
    as_of_date: '2025-11-12',
    sources: ['medexcart.com', 'medexcart.ae', 'Tracxn company profile', 'Prospeo revenue estimate'],
    note: 'CRM tags this deal Saudi Arabia, but the company\'s own site states it is "currently live in Turkey and expanding across the GCC" - used the real operating HQ (Turkey, still on-geography per MENA-other) for scoring. B2B marketplace digitizing dental/medical supply procurement, founded 2021. No funding round found after ~4 years, no founders named in any source, and the only traction figures found are unverified third-party revenue estimates rather than confirmed sales - thin evidence consistent with a quality-driven pass.',
  },
  {
    input: { name: 'Claimkit', industry: 'HealthTech', country: 'Oman', is_b2b: true, team_size: 15, funding_total_usd: 100_000, funding_rounds: 1, time_to_first_funding_months: 6, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: false, stage: 'MVP', founding_year: 2024 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'time_to_first_funding_months'],
    as_of_date: '2026-05-25',
    sources: ['Oman Startup Hub directory', 'PitchBook company profile', 'Tracxn company profile'],
    note: 'AI platform helping doctors draft compliant clinical notes and insurance claims; founded June 2024 by Osama Latrech, raised a small ~$100K round (Plus Venture Capital, Caelestinus, Omantel Innovation Labs), 6-25 person team per the Oman Startup Hub directory. That same directory currently lists the company\'s status as "Inactive" - a plausible deadpool/dormancy signal similar to this cohort\'s QX Lab AI precedent (later deadpooled). Note: at least 3 unrelated companies also use the "ClaimKit" name (US, Australia, Sydney) - this record is the Oman-based entity matching the CRM tag.',
  },
  {
    input: { name: 'eMed Support Systems', industry: 'HealthTech', country: 'United Arab Emirates', is_b2b: true, team_size: 6, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: false, stage: 'MVP', founding_year: 2023 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size'],
    as_of_date: '2025-02-25',
    sources: ['PitchBook company profile', 'Tracxn company profile', 'LinkedIn - founder Dr. Denis Losik'],
    note: 'AI clinical-data platform for proactive cardiovascular patient monitoring without EHR integration, based at in5 Tech, Dubai (matches CRM). Founded 2023 by Dr. Denis Losik (cardiologist), Konstantin Armyanov and Alexey Penskikh; unfunded per PitchBook/Tracxn, 1-10 person team, no traction/revenue signal found in any source - thin evidence consistent with a quality-driven pass; on-geography (UAE).',
  },
  {
    input: { name: 'Cassbana', industry: 'FinTech', country: 'Egypt', is_b2b: true, team_size: 15, funding_total_usd: 1_000_000, funding_rounds: 1, time_to_first_funding_months: 6, has_previous_exit: false, sales_amount_usd: 0, unique_tech: true, technical_cofounder: false, stage: 'Launched', founding_year: 2020 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'time_to_first_funding_months'],
    as_of_date: '2026-04-02',
    sources: ['Launch Base Africa 2024-07 shutdown coverage', 'MENAbytes seed-round coverage', 'Tracxn company profile'],
    note: 'CRM tags this deal Oman, but the company was HQ\'d in Cairo, Egypt (Oman was only a 2023 expansion market) - used the real HQ for scoring, the same pattern as several other CRM country-tag anomalies in this cohort. AI/ML-driven credit scoring and BNPL/inventory financing for underserved SME retailers, founded 2020 by Haitham Nassar, raised ~$1M pre-seed (Jan 2021, Disruptech/MSA Novo/Endure Capital and others). A follow-on $2M commitment from British International Investment was cancelled, and Launch Base Africa reported the company shuttered operations entirely in July 2024 - both facts predate this deal\'s CRM last-touch date (2026-04) and support (not just assume) the quality-driven pass classification; this looks like a stale CRM record on a company that had already failed before the deal was finally marked Passing.',
  },
  {
    input: { name: 'Hollat', industry: 'B2B SaaS', country: 'Saudi Arabia', is_b2b: true, team_size: 8, funding_total_usd: 133_000, funding_rounds: 1, time_to_first_funding_months: 12, has_previous_exit: false, sales_amount_usd: 0, unique_tech: false, technical_cofounder: true, stage: 'MVP', founding_year: 2021 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'founding_year', 'time_to_first_funding_months'],
    as_of_date: '2025-02-27',
    sources: ['Tracxn company profile', 'Crunchbase funding round', 'Hollat company site', 'LinkedIn - co-founder Mahmoud Abdelwahab'],
    note: 'Cloud CRM/ticket-management SaaS for SMEs and government entities, Riyadh-based (matches CRM). Founded by Eng. Saad Al Salama, Eng. Mahmoud Abdelwahab and Mohamed Said Alhabaty (founding year given as 2021 or 2022 across sources - used the earlier figure, flagged as uncertain). Raised only a $133K Flat6Labs seed round, with no team-size or traction data found in any source - a very small round in a crowded, largely undifferentiated CRM/ticketing category reads as a quality-driven pass; on-geography (Saudi Arabia).',
  },
  {
    input: { name: 'OasisX', industry: 'Blockchain', country: 'United Arab Emirates', is_b2b: false, team_size: 10, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: true, technical_cofounder: true, stage: 'Launched', founding_year: 2022 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'funding_total_usd'],
    as_of_date: '2025-03-03',
    sources: ['ITP.net coverage', 'Unlock Blockchain coverage', 'Tracxn company profile'],
    note: 'CRM tags this deal "E-Commerce" but it is a multichain NFT marketplace and no-code NFT creator studio ("LaunchX") - a web3/blockchain platform, not general e-commerce. DMCC-licensed, Dubai-based (matches CRM location), founded 2022 by Jimi Ibrahim, Ramzi Mneimneh and Najib Khanafer; was reportedly raising a $3M seed round in 2022 but no source confirms it closed, so funding is recorded as $0/unconfirmed rather than assumed. Onboarded ~100 artists/brands at launch and expanded to Beirut, but no coverage found after ~2022-2023, coinciding with the broader NFT-market collapse - current operating status is uncertain, consistent with a quality-driven pass rather than a thesis mismatch (UAE is on-geography).',
  },
  {
    input: { name: 'Growa AI', industry: 'AgriTech', country: 'Qatar', is_b2b: true, team_size: 8, funding_total_usd: 0, funding_rounds: 0, time_to_first_funding_months: 0, has_previous_exit: false, sales_amount_usd: 0, unique_tech: true, technical_cofounder: true, stage: 'MVP', founding_year: 2023 },
    actual_outcome: 'passed', pass_kind: 'quality', reason_basis: 'inferred_from_thesis_rubric',
    est_fields: ['team_size', 'founding_year'],
    as_of_date: '2025-02-02',
    sources: ['Gulf Times coverage', 'growa.ai company site', 'Prospeo revenue estimate'],
    note: 'IoT-sensor/satellite-imagery/AI "operating system for smart agriculture," Doha-based (matches CRM), founded by Giuliano Neroni (CTO), Davide Fabris and Jacopo Neroni. Presented at Web Summit Qatar in both 2025 and 2026, addressing Qatar\'s food-import dependency, but no funding round found across either appearance - genuine visibility and government-relevant positioning without a matching funding/revenue signal reads as an early, still-unproven quality-driven pass; on-geography (Qatar).',
  },
];
